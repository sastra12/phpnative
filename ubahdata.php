...
$brg = query("SELECT * FROM barang WHERE idbarang = $id")[0];

if (isset($_POST["submit"])) {
  // cek apa data udah berhasil diubah
  if(ubah($_POST)>0){
    echo "  <script>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action="" method="post">
                              <input type="hidden" name="idbarang" value="<?= $brg["idbarang"] ?>">
                                <div class="card-body">
                                    <h4 class="card-title">Personal Info</h4>
                                    <div class="form-group row">
                                        <label for="nmbarang" class="col-sm-3 text-right control-label col-form-label">Nama Barang</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="namabarang" value="<?= $brg["namabarang"] ?>" id="nmbarang" placeholder="Nama Barang">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="jnsbarang" class="col-sm-3 text-right control-label col-form-label">Jenis Barang</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="jenisbarang" value="<?=$brg["jenisbarang"] ?>" id="jnsbarang" placeholder="Jenis Barang">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="hrgmodal" class="col-sm-3 text-right control-label col-form-label">Harga Modal</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="hargamodal" value="<?=$brg["hargamodal"] ?>" id="hrgmodal" placeholder="Harga Modal">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="hrgjual" class="col-sm-3 text-right control-label col-form-label">Harga Jual</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="hargajual"  value="<?=$brg["hargajual"] ?>" id="hrgjual" placeholder="Harga Jual">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="stok" class="col-sm-3 text-right control-label col-form-label">Stok</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="stok" value="<?=$brg["stok"] ?>" id="stok" placeholder="Stok">
                                        </div>
                                    </div>
                                    <!--<div class="form-group row">
