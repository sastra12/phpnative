       ...
       <div class="page-wrapper">
           ...
           <div class="container-fluid">
               ...
               <div class="row">
                   <div class="col-md-6">
                       <div class="card">
                           <form class="form-horizontal" action="ptransasksi.php" method="post">
                               <div class="card-body">
                                   ...
                                   <div class="form-group row">
                                       ...
                                       <div class="col-sm-9">
                                         <select class="form-control" name="namabarang">
                                           ...
                                           <!--<input type="text" class="form-control" name="namabarang" id="nmbarang" placeholder="Nama Barang">-->
                                       </div>
                                   </div>
                                   <div class="form-group row">
                                       <label for="jmlbarang" class="col-sm-3 text-right control-label col-form-label">Jumlah Barang</label>
                                       <div class="col-sm-9">
                                           <input type="text" class="form-control" name="jmlbarang" id="jmlbarang">
                                       </div>
                                   </div>
                                   <div class="form-group row">
                                       <label for="jmlbayar" class="col-sm-3 text-right control-label col-form-label">Input Bayar</label>
                                       <div class="col-sm-9">
                                   ...
                                   <!--<div class="form-group row">
                                       ...
                                       <div class="col-sm-9">
                                           <input type="text" class="form-control" name="hargajual" id="hrgjual" placeholder="Harga Jual">
                                       </div>
                                   </div>
                                   <div class="form-group row">
