...
if (isset($_POST["submit"])) {
  // cek apa data udah berhasil ditambahakan
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="tabel.php" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">Data Barang</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Forms </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="tambahbarang.php" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> Tambah Barang </span></a></li>
                                <li class="sidebar-item"><a href="datatransaksi.php" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Data Transaksi Penjualan </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="cobatransaksi1.php" aria-expanded="false"><i class="mdi mdi-pencil"></i><span class="hide-menu">Transaksi Penjualan</span></a></li>
                        <li class="sidebar-item"><a href="logout.php" class="sidebar-link"><i class="mdi mdi-bulletin-board"></i><span class="hide-menu"> Logout </span></a></li>
                    </ul>
                </nav>
                            ...
                            <form class="form-horizontal" action="" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="nmbarang" class="col-sm-3 text-right control-label col-form-label">Nama Barang</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="namabarang" id="nmbarang" placeholder="Nama Barang" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="jnsbarang" class="col-sm-3 text-right control-label col-form-label">Jenis Barang</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="jenisbarang" id="jnsbarang" placeholder="Jenis Barang">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="hrgmodal" class="col-sm-3 text-right control-label col-form-label">Harga Modal</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="hargamodal" id="hrgmodal" placeholder="Harga Modal" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="hrgjual" class="col-sm-3 text-right control-label col-form-label">Harga Jual</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="hargajual" id="hrgjual" placeholder="Harga Jual" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="stok" class="col-sm-3 text-right control-label col-form-label">Stok</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="stok" id="stok" placeholder="Stok" autocomplete="off">
                                        </div>
                                    </div>
                                    <!--<div class="form-group row">
